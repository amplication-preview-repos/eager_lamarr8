...
@InputType()
class SyntaxCreateInput {
  @ApiProperty({
    required: false,
    type: () => CodeFileCreateNestedManyWithoutSyntaxesInput,
  })
  @ValidateNested()
  @Type(() => CodeFileCreateNestedManyWithoutSyntaxesInput)
  @IsOptional()
  @Field(() => CodeFileCreateNestedManyWithoutSyntaxesInput, {
    nullable: true,
  })
...
export { SyntaxCreateInput as SyntaxCreateInput };
